...
intovalue <- read_csv("data/2_dataset_cleaning/final_dataset/iv_main_dataset.csv")
...
write_csv(lookup_registries, "data/2_dataset_cleaning/final_dataset/iv_data_lookup_registries.csv")
