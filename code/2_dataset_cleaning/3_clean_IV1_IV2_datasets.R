...
intovalue <- 
  read_csv(
    "data/2_dataset_cleaning/intermediate_cleaning_steps/IV1_IV2_combined_dataset.csv",
    col_types = cols(
...
write_csv(intovalue_clean, "data/2_dataset_cleaning/intermediate_cleaning_steps/iv_clean_dataset.csv")
