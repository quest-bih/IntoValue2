...
iv_dataset <- read_csv("data/2_dataset_cleaning/final_dataset/iv_main_dataset.csv")
...
write_rds(iv_trials_per_city, "code/4_shiny_app/data/IntoValue_Dataset_combined.rds")
write_csv(iv_trials_per_city, "code/4_shiny_app/data/IntoValue_Dataset_combined.csv")
